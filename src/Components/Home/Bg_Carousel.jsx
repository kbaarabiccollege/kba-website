...
export function Bg_Carousel() {
  ...
  return (
    <>
      ...
      <p className="font-bold lg:text-5xl w-fit   mx-auto absolute xl:top-[35%] text-white z-30 brightness-200 font-opensans text-3xl top-48 left-[30%] md:left-[30%] md:top-[27%] lg:top-[38%] lg:left-[25%]   xl:right-[25%]  xl:text-[3rem]  ">Admissions  <br className="md:hidden" /><span className="font-Roboto relative left-3 md:left-0 font-bold w-fit  text-[#A02021]">Open 2025</span></p>
      ...
      <div className=" opacity-90 ">
        <ImagesSlider className="h-[100vh] md:h-[45rem]" images={images}>
          <motion.div
            initial={{
              opacity: 0,
              y: -80,
